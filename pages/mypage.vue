  ...
  <v-layout>
    ...
    <v-tabs-items v-model="tab">
      ...
      <v-tab-item v-for="novel in all" :key="novel">
        <v-container>
          <v-row>
            <v-col v-for="(n, index) in n" :key="index" cols="12" sm="6" md="4" class="d-flex">
              <v-card width="100%">
    ...
    return {
      ...
      all: [
        [
          {
            'novel-title': 'bbbbbbb',
            'novel-headline': 'aaaaaaaaaaa',
            'novel-id': 1
          }
        ],
        [{ 'novel-title': 'cccc', 'novel-headline': 'dddd', 'novel-id': 2 }]
      ],
      histories: [
        {
          'novel-title': 'dleta大冒険',
          'novel-headline': 'aaaaaaaaaaa',
          'novel-id': 1
        }
      ]
